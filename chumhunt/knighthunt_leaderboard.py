...
pygame.display.set_caption("Chum Games | Knight Hunt Leaderboard")

run = True

font = pygame.font.SysFont('comicsans', int(round(3/25*size)))

dico = load_obj("./chumhunt/knighthunt_score.txt")    #Importe le dico
...
lb_title = font.render("Knight Hunt Leaderboard", True, c.blue)
